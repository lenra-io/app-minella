...
import { singlePlayer, multiPlayer } from '../utils/icons.js';
 ...
 * @returns
 */
export function gameCard(players, props) {
                ...
                children: [
                    {
                        ...
                        children: [{
                            ...
                            value: props.game.playerNumber == 1 ? singlePlayer : multiPlayer
                        },
                        {
                            type: "text",
                            style: {
...
export function filterButton(players, props) {
    return {
        type: "actionable",
        onPressed: {
            action: "applyFilter",
